...
public sealed class ElarionStagedUploadsGeneratorTests {
    ...
    public void EmitsDbSetAndModelConfigurationSeam() {
        ...
        source.Should()
            .Contain("partial void OnEntitiesConfigured_GenerateElarionStagedUploads(ModelBuilder modelBuilder) =>");
    ...
    public void ComposesWithEfGeneratorSeamAndCompiles() {
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            new[] {
                new DbContextGenerator().AsSourceGenerator(), new ElarionStagedUploadsGenerator().AsSourceGenerator()
            },

...
public sealed class ElarionActorSnapshotsGeneratorTests {
    ...
    public void EmitsDbSetAndModelConfigurationSeam() {
        ...
        source.Should()
            .Contain("partial void OnEntitiesConfigured_GenerateElarionActorSnapshots(ModelBuilder modelBuilder) =>");
    ...
    public void ComposesWithEfGeneratorSeamAndCompiles() {
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            new[] {
                new DbContextGenerator().AsSourceGenerator(), new ElarionActorSnapshotsGenerator().AsSourceGenerator()
            },

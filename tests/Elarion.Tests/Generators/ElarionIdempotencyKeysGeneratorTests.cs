...
public sealed class ElarionIdempotencyKeysGeneratorTests
{
    ...
    public void EmitsDbSetAndModelConfigurationSeam()
    {
        ...
        source.Should().Contain("partial void OnEntitiesConfigured_GenerateElarionIdempotencyKeys(ModelBuilder modelBuilder) =>");
    ...
    public void ComposesWithEfGeneratorSeamAndCompiles()
    {
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            new[] { new DbContextGenerator().AsSourceGenerator(), new ElarionIdempotencyKeysGenerator().AsSourceGenerator() },

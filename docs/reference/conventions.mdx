...
<Callout type="info">
  ...
  `[ModuleContract]`, never its internal `[Service]`, handler, `[EntityConfiguration]`, or configured-entity
  types (the entity behind an `[EntityConfiguration]`, since entities carry no marker). The

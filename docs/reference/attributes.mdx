...
<Callout type="warn">
  **Runtime:** the cache itself was extracted out of Elarion core ([ADR-0017](/docs/decisions)). `[Cacheable]`/`[CacheInvalidate]`
...
<Callout type="warn">
  **Runtime:** the resilience runner was extracted out of Elarion core ([ADR-0017](/docs/decisions)). `[Resilient]`
...
<Cards>
  <Card title="Diagnostics" href="/docs/reference/diagnostics">Compiler diagnostic ids (ELMOD/ELHTTP/ELRPC/ELEVT/ELKEY/ELAPI/ELSG/ELFEAT/ELVAR/ELAUTH/ELPOL/ELPERM/ELRES/ELRG/ELIDN/ELCACHE) referenced above.</Card>

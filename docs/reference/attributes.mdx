...
staged-blob tier instead (ADR-0038). See
...
See [Modules](/docs/concepts/modules#declaring-the-hooks-outside-the-module-moduleendpoints) and [ADR-0039](https://github.com/swimmesberger/Elarion/blob/main/docs/decisions/0039-host-declared-module-endpoints.md).

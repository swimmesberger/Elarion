...
<Cards>
  <Card title="Diagnostics" href="/docs/reference/diagnostics">Compiler diagnostic ids (ELMOD/ELHTTP/ELRPC/ELEVT/ELKEY/ELAPI/ELSG/ELFEAT/ELVAR/ELPERM/ELCACHE/ELRES) referenced above.</Card>

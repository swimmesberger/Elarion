...
| ASP.NET Core host | `Elarion.JsonRpc`, `Elarion.AspNetCore`, `Elarion.Generators` (analyzer); optionally `Elarion.AspNetCore.SchemaGeneration` (build tooling) and `Elarion.AspNetCore.Mcp` (MCP server). |

...
`rpc-schema.json` is the contract that drives the [TypeScript client](/docs/json-rpc/typescript-client).
...
actionable error instead of writing a stale schema. See [Hosting](/docs/json-rpc/hosting) for the
registration.

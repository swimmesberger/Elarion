...
path](/docs/json-rpc/hosting)), which exposes the gated MCP peers alongside the JSON-RPC and HTTP ones:
...
[source generator](/docs/source-generation): a reflection-free tool table plus the registration delegate

...
so each can evolve independently — see [ADR-0010](../decisions/0010-runtime-settings-subsystem.md).
...
<Callout type="info">
  ...
  are planned providers over the same contracts.
</Callout>
...
[ADR-0010](../decisions/0010-runtime-settings-subsystem.md) for the full design and phasing.

...
Modules collaborate **asynchronously** through the [event planes](/docs/events). For **direct,
...
and not an extraction path (see [events](/docs/events)). A `[ModuleContract]` is the stable seam that

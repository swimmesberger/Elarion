...
[user-scoped caching](/docs/concepts/caching). Elarion exposes this through a transport-neutral
...
[`CurrentUser`-scoped caching](/docs/concepts/caching) depends on this abstraction: the cache uses

...
Concretely, a `[Service]`, a handler, an `[EntityConfiguration]`, or a configured entity (the entity
behind an `[EntityConfiguration]`, since entities carry no marker) declared *inside* module A cannot be

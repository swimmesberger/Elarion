...
contract ([ADR-0052](https://github.com/swimmesberger/Elarion/blob/main/docs/decisions/0052-ordered-streams.md)).
...
| --- | --- | --- |
| One request returns a lazy export, token output, or tail query | One caller owns one response | [`IStreamHandler`](/docs/capabilities/transports/server-streaming) |
...
contract; use a cold [`IStreamHandler`](/docs/capabilities/transports/server-streaming) when one request

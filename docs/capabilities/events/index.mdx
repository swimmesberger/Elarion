...
[Consuming events](/docs/capabilities/events/consuming-events) for the consumer model.
...
<Cards>
  ...
  <Card title="ADR 0001 — Event transaction phase" href="https://github.com/swimmesberger/Elarion/blob/main/docs/decisions/0001-event-transaction-phase.md">

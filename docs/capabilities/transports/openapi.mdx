...
Elarion adds only the wiring Microsoft can't ([ADR-0026](https://github.com/swimmesberger/Elarion/blob/main/docs/decisions/0026-openapi-http-transport.md)).

## Enable it

```xml
<ItemGroup>
  <PackageReference Include="Elarion.AspNetCore.OpenApi" Version="0.2.6" />
</ItemGroup>
```
...
```xml
<ItemGroup>
  <!-- Version tracks your .NET SDK (10.0.x for net10.0) -->
  <PackageReference Include="Microsoft.Extensions.ApiDescription.Server" Version="0.2.6" />
</ItemGroup>

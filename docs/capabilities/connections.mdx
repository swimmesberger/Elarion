...
wanted. The pipeline is benchmarked at **raw-socket parity with zero allocations per message**, and an
armed-but-quiet idle window costs nothing on the hot path.

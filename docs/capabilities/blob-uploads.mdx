...
and instances**, add the durable PostgreSQL staging store — it persists staged bytes and reaps expired
sessions (the analog of S3's *abort incomplete multipart upload*):

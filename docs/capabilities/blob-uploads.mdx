...
| `Elarion.Blobs.AspNetCore` | Host | The minimal direct-upload endpoint (`MapElarionBlobUploads`, `AddElarionBlobUploads`) and the owner-scoped streaming download endpoint (`MapElarionBlobDownloads`). |

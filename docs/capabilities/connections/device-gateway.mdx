...
internal sealed class DeviceTwinAttachment(IActorSystem actors) : IClientConnectionObserver {
    ...
    public ValueTask OnIdentityPromotedAsync(ClientConnection previous, ClientConnection current,
        CancellationToken ct = default) => ValueTask.CompletedTask;   // links here authenticate at connect
}

...
abstraction. If your configurations live in a separate domain project, that project needs this
reference too, so its generator emits the per-assembly configuration manifest the context project
reads:

...
- [ADR-0038: File payloads — the in-memory `ElarionFile` tier and the staged-blob tier](0038-binary-file-responses.md)
- [ADR-0039: Host-declared module endpoint hooks (`[ModuleEndpoints]`)](0039-host-declared-module-endpoints.md)

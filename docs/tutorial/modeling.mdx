...
[EF Core generator](/docs/entity-framework) emits a `DbSet<T>` for every `[DbEntity]`.
...
you add handlers — each module contributes its own [source-generated JSON metadata](/docs/json-rpc/serialization).

...
[scheduler telemetry](/docs/telemetry).
...
- Fixed-rate and cron schedules **skip missed in-process slots** instead of replaying a burst (tunable
  with [misfire policy](/docs/scheduling/overlap-and-misfire)).
...
- Scheduling, enqueue, cancel, and execution all emit [telemetry](/docs/telemetry).
...
<Cards>
  <Card title="Schedules" href="/docs/scheduling/schedules">FixedRate, FixedDelay, Cron, initial delay, and config placeholders.</Card>
  <Card title="Overlap & misfire" href="/docs/scheduling/overlap-and-misfire">What happens when runs collide or fall behind.</Card>
  <Card title="Runtime jobs" href="/docs/scheduling/runtime-jobs">Typed one-off jobs scheduled at runtime with a payload.</Card>
  <Card title="Inspection" href="/docs/scheduling/inspection">Snapshots, next-due times, and cancellation.</Card>
</Cards>

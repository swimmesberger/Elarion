...
[EF Core generator](/docs/capabilities/entity-framework) emit the `DbSet`s.
...
This step needs `Elarion.EntityFrameworkCore` (which bundles the EF Core source generator) and an EF

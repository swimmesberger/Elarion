...
[Source generation](/docs/source-generation).
...
See [JSON-RPC schema generation](/docs/json-rpc/schema-generation) for the full set of properties.
...
[TypeScript client](/docs/json-rpc/typescript-client) for usage.

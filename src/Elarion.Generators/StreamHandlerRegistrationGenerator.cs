...
public sealed class StreamHandlerRegistrationGenerator : IIncrementalGenerator {
    ...
    private static string Emit(StreamInfo handler) {
        ...
        sb.AppendLine("// <auto-generated/>").AppendLine("#nullable enable").AppendLine("#pragma warning disable CS1591 // Generated code is not documented; a consuming project that enables GenerateDocumentationFile must not be warned about it.")

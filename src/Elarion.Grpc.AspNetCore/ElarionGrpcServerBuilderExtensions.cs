...
/// <summary>Composes Elarion's unary handler transport with an ASP.NET Core grpc-dotnet server.</summary>
public static class ElarionGrpcServerBuilderExtensions {
    /// <summary>
    /// Adds Elarion's unary handler transport to a server registered with <c>AddGrpc()</c>. The authenticated

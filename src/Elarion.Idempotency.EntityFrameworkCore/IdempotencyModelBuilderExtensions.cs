...
public static class IdempotencyModelBuilderExtensions {
    ...
    public static ModelBuilder ApplyElarionIdempotencyKeys(
        ...
        modelBuilder.Entity<IdempotencyKeyEntity>(builder => {
            ...
            builder.Property(entity => entity.Operation).HasColumnName(snakeCase ? "operation" : "Operation")
                .HasMaxLength(256);
            ...
            builder.Property(entity => entity.Fingerprint).HasColumnName(snakeCase ? "fingerprint" : "Fingerprint")
                .HasMaxLength(128);
            ...
            builder.Property(entity => entity.CompletedOnUtc)
                .HasColumnName(snakeCase ? "completed_on_utc" : "CompletedOnUtc");
            builder.Property(entity => entity.ExpiresOnUtc)
                .HasColumnName(snakeCase ? "expires_on_utc" : "ExpiresOnUtc");

            builder.Property(entity => entity.Version).HasColumnName(snakeCase ? "version" : "Version")
                .IsConcurrencyToken();

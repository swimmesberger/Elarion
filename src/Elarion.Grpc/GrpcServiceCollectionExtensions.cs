...
public static class GrpcServiceCollectionExtensions {
    /// <summary>
    /// Registers the unary invoker, default error translator, and a delegate that returns the principal already
    /// authenticated by the host. This does not add or configure a gRPC server.
    /// </summary>
    ...
    /// <summary>
    /// Registers the unary invoker, default error translator, and <paramref name="principalFactory"/> as the
    /// host-specific principal source. This overload avoids reflection-based activation and does not add or
    /// configure a gRPC server.
    /// </summary>
    public static IServiceCollection AddElarionGrpcTransport(
        this IServiceCollection services,

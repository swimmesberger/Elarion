...
public sealed class ElarionSchedulerClaimsGenerator : IIncrementalGenerator {
    private const string AttributeMetadataName =
        "Elarion.Scheduling.EntityFrameworkCore.GenerateElarionSchedulerClaimsAttribute";
    ...
    private static void Emit(SourceProductionContext spc, SchedulerClaimsTarget target) {
        ...
        sb.AppendLine("{");
        sb.AppendLine(
            $"    public DbSet<{SchedulingNamespace}.SchedulerClaimEntity> SchedulerClaims => Set<{SchedulingNamespace}.SchedulerClaimEntity>();");
        sb.AppendLine();
        sb.AppendLine(

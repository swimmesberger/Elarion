...
/// <see cref="DbDataSource"/> over <c>Microsoft.Data.Sqlite</c> plus the <see cref="ISqlDatabase"/>
...
public static class SqliteServiceCollectionExtensions {
    ...
    /// <c>Data Source=app.db</c>): a <see cref="DbDataSource"/> and the <see cref="ISqlDatabase"/>
    ...
    public static IServiceCollection AddElarionSqlite(this IServiceCollection services, string connectionString) {
        ...
        services.AddElarionSqlDatabase(sp => sp.GetRequiredService<DbDataSource>());

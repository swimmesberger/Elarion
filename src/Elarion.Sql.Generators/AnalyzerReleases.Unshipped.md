...
--------|----------|----------|------
ELSQL001 | Elarion.Sql | Error | Property type is not a supported SQL column type
ELSQL002 | Elarion.Sql | Error | Two properties map to the same column name
ELSQL003 | Elarion.Sql | Error | Required property is excluded from mapping
ELSQL004 | Elarion.Sql | Error | [SqlRecord] type has no mapped columns

...
public sealed partial class SqlRecordMapperGenerator {
    private static void EmitMapper(SourceProductionContext context, SqlRecordModel model, SqlProviderKind provider) {
        ...
        builder.AppendLine("#pragma warning disable CS1591 // Generated code is not documented; a consuming project that enables GenerateDocumentationFile must not be warned about it.");
        builder.AppendLine();

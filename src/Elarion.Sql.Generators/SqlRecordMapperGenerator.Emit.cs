    ...
    private static void EmitMapper(SourceProductionContext context, SqlRecordModel model, SqlProviderKind provider) {
        ...
        if (model.RequiresJson) {
            builder.AppendLine($$"""
                    ...
                    /// <summary>
                    /// JSON columns serialize through the canonical accessor (ADR-0023), so this mapper is
                    /// constructed with it (the generated DI registration does this automatically).
                    /// </summary>
            ...
            foreach (var column in columns) {
                ...
                builder.AppendLine($$"""
                        ...
                        private global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<{{column.JsonTypeFqn}}> JsonTypeInfo{{column.PropertyName}} =>
                            _jsonTypeInfo{{column.PropertyName}} ??= _json.GetTypeInfo<{{column.JsonTypeFqn}}>();
                    """);
            }
        }
        else {

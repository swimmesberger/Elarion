...
namespace Elarion.AspNetCore.Identity.Generators;
...
public sealed class ElarionIdentityGenerator : IIncrementalGenerator {
    private const string AttributeMetadataName = "Elarion.AspNetCore.Identity.GenerateElarionIdentityAttribute`3";
    ...
    private static void Emit(SourceProductionContext spc, IdentityTarget target) {
        ...
        sb.AppendLine("// Source: Elarion.AspNetCore.Identity.Generators.ElarionIdentityGenerator");
        ...
        sb.AppendLine(
            $"        global::Elarion.AspNetCore.Identity.IdentityModelBuilderExtensions.ApplyElarionIdentity<{target.UserFqn}, {target.RoleFqn}, {target.KeyFqn}>(");
